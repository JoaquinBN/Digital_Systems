    ...
    switch (state){
        ...
        case 2:
            if (colIndex >= 3 ){
                ...
                if(getDigitValue() == '*'){
                    state = 0;
                }else if (getDigitValue() == '#' && colIndex == 2){
                    tmpPortChar = 1;
                    state = 8;
        ...
        case 84:
            ...
            break;
        case 85:
            if(TI_GetTics(timer) >= 4000 && index != 2){
                index--;
                playMusic(index);
                TI_ResetTics(timer);
            }else if (index == 2){
