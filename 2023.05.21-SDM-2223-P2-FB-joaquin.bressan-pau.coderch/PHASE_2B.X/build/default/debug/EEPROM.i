...
void memoryLoop(void){
    switch(state){
        ...
        case 2:
            ...
            if(EECON1bits.WR == 0){
                saveData(0x20 + indexEEPROM%8, recordings[indexEEPROM%8].timestamp.minutes);
                state = 3;
            }
            break;
        case 3:
            if(EECON1bits.WR == 0){
                saveData(0x30 + indexEEPROM%8, recordings[indexEEPROM%8].timestamp.seconds);
                state = 4;
            }
            break;
        case 4:
        ...
        case 11:
            if(EECON1bits.WR == 0){
                saveData(0x10 + indexEEPROM%8, recordings[indexEEPROM%8].index);
                indexEEPROM++;
                state = 12;
            }
            break;
        ...
        case 30:
            if(checkTX()){
                setTX(recordings[indexTemp].index);
                state = 0;
            }
            break;
        ...
        case 41:
            if(EECON1bits.WR == 0){
                recordings[indexEEPROM].index = readData(0x10 + indexEEPROM);
                state = 42;
            }
        case 42:
            if(EECON1bits.WR == 0){
                recordings[indexEEPROM].timestamp.minutes = readData(0x20 + indexEEPROM);
                state = 43;
            }
            break;
        case 43:
            if(EECON1bits.WR == 0){
                recordings[indexEEPROM].timestamp.seconds = readData(0x30 + indexEEPROM);
                indexEEPROM++;
                state = 44;
            }
            break;
...
char getNumRecordings(void){
    return (indexEEPROM > 8? 7 : (indexEEPROM == 0? 0: indexEEPROM-1));
}
